#!/usr/bin/env python3
"""Generate MariaDB init DDL/DML fixtures with configurable table and row counts."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate MariaDB init SQL fixtures.")
    parser.add_argument(
        "--output-dir",
        type=Path,
