...
Coordinates: `com.sviat-tech` / `<version>` (any dotted release, e.g. `1.0`, `1.0.1`, `1.0.1.0`).
...
dependencies {
    ...
    testImplementation "com.sviat-tech:preinit-testcontainers:1.0.1"
...
dependencies {
    testImplementation platform("org.testcontainers:testcontainers-bom:2.0.4")
    testImplementation "com.sviat-tech:preinit-testcontainers-jdbc:1.0.1"
    // your JDBC driver
    testImplementation "org.testcontainers:testcontainers-junit-jupiter"
    testImplementation "org.junit.jupiter:junit-jupiter"
}
...
dependencies {
    testImplementation platform("org.testcontainers:testcontainers-bom:2.0.4")
    testImplementation "com.sviat-tech:preinit-testcontainers-mysql:1.0.1"
...
dependencies {
    testImplementation platform("org.testcontainers:testcontainers-bom:2.0.4")
    testImplementation "com.sviat-tech:preinit-testcontainers-postgresql:1.0.1"
...
dependencies {
    testImplementation platform("org.testcontainers:testcontainers-bom:2.0.4")
    testImplementation "com.sviat-tech:preinit-testcontainers-clickhouse:1.0.1"
...
dependencies {
    testImplementation platform("org.testcontainers:testcontainers-bom:2.0.4")
    testImplementation "com.sviat-tech:preinit-testcontainers-redis:1.0.1"
    testImplementation "org.testcontainers:testcontainers-junit-jupiter"
    testImplementation "org.junit.jupiter:junit-jupiter"
}
```
...
```groovy
testImplementation "com.sviat-tech:preinit-testcontainers:1.0.1-SNAPSHOT"
testImplementation "org.testcontainers:testcontainers-junit-jupiter"
```
